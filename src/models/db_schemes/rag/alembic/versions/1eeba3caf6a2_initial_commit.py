...
Revision ID: 1eeba3caf6a2
Revises: 
Create Date: 2025-10-19 09:45:50.508346
...
def upgrade() -> None:
    ...
    sa.Column('chunck_asset_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['chunck_asset_id'], ['assets.asset_id'], ),
    sa.ForeignKeyConstraint(['chunk_project_id'], ['projects.project_id'], ),
    sa.PrimaryKeyConstraint('chunk_id'),
    sa.UniqueConstraint('chunk_uuid')
    )
    op.create_index('ix_chunck_asset_id', 'chunks', ['chunck_asset_id'], unique=False)
