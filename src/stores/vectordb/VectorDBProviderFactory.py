    ...
    def create(self, provider: str):
        if provider == VectorDBEnums.QDRANT.value:
            ...
            return QdrantDBProvider(
                ...
                distance_methods=self.config.VECTOR_DB_DISTANCE_METHOD,
                def_vector_size=self.config.EMBEDDING_MODEL_SIZE ,
                index_threshold=self.config.VECTOR_DB_PGVEC_INDEX_THREADHOLD
            )
